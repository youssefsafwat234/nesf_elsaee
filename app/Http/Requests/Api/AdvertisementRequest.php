...
class AdvertisementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'real_estate_age_number' => ['integer', 'min:1', 'required_if:real_estate_age,مستعمل'],
            ...
            'bedrooms_number' => ['integer', 'min:1'],
            'bathrooms_number' => ['integer', 'min:1'],
            'reception_and_sitting_rooms_number' => ['integer', 'min:1'],
            'street_width' => ['numeric', 'min:0'],
            'surrounding_streets_number' => ['integer', 'min:0'],
    ...
    public function messages(): array
    {
        return [
            ...
            'real_estate_age_number.integer' => 'رقم عمر العقار يجب أن يكون عدداً صحيحاً.',
            ...
            'bedrooms_number.integer' => 'عدد غرف النوم يجب أن يكون عدداً صحيحاً.',
            'bedrooms_number.min' => 'عدد غرف النوم يجب أن يكون 1 على الأقل.',

            'bathrooms_number.integer' => 'عدد الحمامات يجب أن يكون عدداً صحيحاً.',
            'bathrooms_number.min' => 'عدد الحمامات يجب أن يكون 1 على الأقل.',

            'reception_and_sitting_rooms_number.integer' => 'عدد غرف الاستقبال يجب أن يكون عدداً صحيحاً.',
            ...
            'surrounding_streets_number.integer' => 'عدد الشوارع المحيطة يجب أن يكون عدداً صحيحاً.',
